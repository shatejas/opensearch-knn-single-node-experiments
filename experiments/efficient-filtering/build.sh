...
PARAMS_PATH="experiments/efficient-filtering/osb-params"
...
setup_environment ${TMP_ENV_DIR} ${TMP_ENV_NAME} "efficient-filtering" faiss-hnsw.json "no-train-test" true
